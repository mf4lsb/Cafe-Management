...
session_start();
$jmlPesanan = $_SESSION['jmlPesanan'];
$_SESSION['jumlahPesanan'] = $jmlPesanan;
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <h1>Pesanan Pemesan</h1>
            <div class="pt-2"></div>
            <form action="controller/Pemesanan2.php" method="post">
              <div class="form-group">
              <?php for($i = 1 ; $i <= $jmlPesanan ; $i++):?>
                <?php
                    $sql = "SELECT menu FROM tb_menu";
                    $result = mysqli_query($conn,$sql);
                ?>
                <h3>Menu<?=$i;?></h3>
                <label for="exampleInputEmail1">Daftar Menu</label>
                <select name="menu<?= $i;?>" id="" class="form-control col-sm-3">
                <?php
