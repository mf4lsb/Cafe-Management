      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <h1 class="pb-2">Daftar Pelayan</h1>
            <button class="btn btn-primary btn-sm mb-4" style="border-radius: 8px;" data-toggle="modal" data-target="#exampleModalCenter">Tambah Pelayan</button>   
<?php
...
?>
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Tambah Pelayan</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <form action="controller/AddWaiters.php" method="post">
            <div class="modal-body">
              <div class="form-group">
                <input type="text" name="addWaiters" placeholder="Tambah Pelayan" class="form-control">
              </div>
            </div>
            <div class="modal-footer">
